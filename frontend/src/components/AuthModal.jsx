...
export default function AuthModal({ isOpen, onClose, onAuthSuccess, initialView = 'signIn' }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="relative w-full max-w-md bg-white border border-slate-200 rounded-3xl shadow-2xl p-6 md:p-8 overflow-hidden">
        
        {/* Top Gradient Border Accent */}
        <div className="absolute top-0 left-0 right-0 h-1.5 bg-gradient-to-r from-indigo-500 via-indigo-600 to-violet-500" />

        {/* Close Button */}
        <button
          onClick={onClose}
          className="absolute top-4 right-4 p-1.5 text-slate-400 hover:text-slate-700 rounded-lg hover:bg-slate-100 transition-colors z-20"
        ...
        {/* Message Banner */}
        {message.text && (
          <div className={`mb-5 p-3.5 rounded-xl text-xs font-medium flex items-center gap-2 border ${
            message.type === 'error'
        ...
        {view === 'signIn' && (
          <form onSubmit={handleSignIn} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:border-indigo-600 focus:ring-1 focus:ring-indigo-600 transition-colors"
                  required
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-10 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:border-indigo-600 focus:ring-1 focus:ring-indigo-600 transition-colors"
                  required
                />
                <button
                  type="button"
            ...
            <div className="flex items-center justify-between text-xs pt-1">
              <label className="flex items-center gap-2 text-slate-600 cursor-pointer">
                <input
                  ...
                  className="w-4 h-4 rounded bg-slate-100 border-slate-300 text-indigo-600 focus:ring-indigo-500"
                />
                Remember Me
              </label>
              <button
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full mt-2 py-3 px-4 bg-indigo-600 hover:bg-indigo-700 disabled:bg-slate-200 disabled:text-slate-400 text-white text-sm font-semibold rounded-xl shadow-sm transition-all flex items-center justify-center gap-2"
            >
            ...
            {signUpStep === 1 && (
              <form onSubmit={handleSignUpEmail} className="space-y-4">
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="w-full py-3 px-4 bg-indigo-600 hover:bg-indigo-700 disabled:bg-slate-200 disabled:text-slate-400 text-white text-sm font-semibold rounded-xl shadow-sm transition-all flex items-center justify-center gap-2"
                >
            ...
            {signUpStep === 2 && (
              <form onSubmit={handleVerifySignUpOtp} className="space-y-4">
                <div className="p-3.5 bg-slate-50 border border-slate-200 rounded-xl text-xs text-slate-600 flex items-center justify-between">
                  <span>Code sent to <strong className="text-indigo-600">{email}</strong></span>
                  <button
                    type="button"
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="000000"
                    maxLength={6}
                    className="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-center tracking-widest font-mono text-lg text-slate-900 placeholder:text-slate-300 focus:outline-none focus:border-indigo-600 focus:ring-1 focus:ring-indigo-600 transition-colors"
                    required
                  />
                </div>
                ...
                <div className="text-center text-xs text-slate-500 pt-1">
                  <button
                    ...
                    className="text-indigo-600 hover:underline font-medium disabled:text-slate-400"
                  >
          ...
          <div className="space-y-4">
            ...
            {forgotStep === 2 && (
              <form onSubmit={handleVerifyForgotOtp} className="space-y-4">
                <div className="p-3.5 bg-slate-50 border border-slate-200 rounded-xl text-xs text-slate-600 flex items-center justify-between">
                  <span>Reset code sent to <strong className="text-indigo-600">{email}</strong></span>
                  <button
                    type="button"
